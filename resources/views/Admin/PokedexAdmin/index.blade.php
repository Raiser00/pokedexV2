<x-app-layout>
    <div class="container mx-auto p-4">
        ...
        <div class="flex justify-center space-x-2">
            <input type="text" name="search" id="search" placeholder="Rechercher un Pokémon" class="border border-red-500 rounded shadow px-2 py-1 w-1/3 focus:ring-2 focus:ring-red-500" value="{{ request()->search }}" autofocus />
            <button type="submit" class="bg-red-500 text-white rounded shadow px-2 py-1 hover:bg-red-600 transition duration-300">
                Catch
            </button>
        </div>
